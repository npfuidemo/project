...
function addDropdownOption(){
    ...
    $("#dropdownOptionContainerDiv").append('<div class="row"><br><div class="col-md-9 padding-left-0"><input type="text" name="dropdown_option[]" class="form-control dropdown_option" placeholder="Dropdown Option '+(parseInt($(".dropdown_option").length)+1)+'"></div><div class="col-md-3"><label><input type="radio" name="default_dropdown_option">Make Default</label><a onclick="removeDropdownOption(this);" href="javascript:void(0);" class="padding-left-10"><i class="fa fa-minus"></i></a></div></div>');
}
