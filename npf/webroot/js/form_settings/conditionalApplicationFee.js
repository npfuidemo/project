$(document).ready(function () {
    ...
    $('select.payment_currency_class').SumoSelect({placeholder: 'Select Currency Type', captionFormatAllSelected: "All Selected.", triggerChangeCombined: true });
...
function addConditionalFeeBlock(formId, GSTBreakUpAllowed, pgChargesApplicable, defaultCurrencyCode){
    ...
    $.ajax({
        ...
        type: 'post',
        dataType: 'html',
        data: { logicNumber:logicNumber, formId:formId, GSTBreakUpAllowed:GSTBreakUpAllowed,
            pgChargesApplicable:pgChargesApplicable, defaultCurrencyCode:defaultCurrencyCode },
