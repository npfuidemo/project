...
function setValueRadio(field)
{
	if(field == 'form_redirect_option')
	{
		document.getElementById('form_redirect_option').value = 1;
		document.getElementById('form_success_message_option').value = 0;
	}
	else if(field == 'form_success_message_option')
	{
		document.getElementById('form_redirect_option').value = 0;
		document.getElementById('form_success_message_option').value = 1;
	}
}
