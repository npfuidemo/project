            ...
            <div class="transfer-double" id="transfer_double_{{= self.id }}">
                ...
                <div class="transfer-double-content clearfix">
                    ...
                    <div class="transfer-double-content-middle">
                        <div class="btn-select-arrow" id="add_selected_{{= self.id }}"><span class="material-icons">chevron_right</span></div>
                        <div class="btn-select-arrow" id="delete_selected_{{= self.id }}"><span class="material-icons">chevron_left</span></div>
                    </div>
...
;(function ($) {
    ...
    $(document).on("click",".transfer-double-list-li",function() {
        $(".transfer-double-content-middle .btn-select-arrow:first-child").trigger("click");
    });
    $(document).on("click",".transfer-double-selected-list-li",function() {
        $(".transfer-double-content-middle .btn-select-arrow:last-child").trigger("click");
    });
})(jQuery);
